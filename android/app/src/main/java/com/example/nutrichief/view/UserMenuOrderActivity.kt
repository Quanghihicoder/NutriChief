...
import com.example.nutrichief.adapter.RecyclerOrderItemAdapter
...
class UserMenuOrderActivity : AppCompatActivity(), RecyclerOrderItemAdapter.OnItemClickListener, TimePickerDialog.OnTimeSetListener {
    ...
    //load order details (price, tax and total)
    ...
    //read the data from food database and display the list
